...
class SettingPage extends React.PureComponent {
  ...
  renderDraggableAttrListSettings = (attr, index) => {
    return (
      < div
    key = {attr.name}
    className = {styles.draggedWrapper} >
      < div > {index +1}. < /div>
      < DraggableAttr
    index = {index}
  ...
  renderDropDownItemSettingField = item => {
    ...
    onClick = {()
  =>
    this.props.onClickAddAttrField(item, `${this.getPath()}.editDisplay.fields`)
  }
  >
    {
      item
  ...
  renderDropDownItemEditSettingsRelation = item => {
    ...
    onClick = {()
  =>
    this.props.onClickAddAttr(item, `${this.getPath()}.editDisplay.relations`)
  }
  >
    {
      item
...
<
  ...
  className = "row" >
    < div
  className = {cn('col-md-12', styles.editFormTitle
)
}>
<
  FormTitle
  ...
  className = "col-md-12" >
    < div
  className = {styles.separatorHigher}
  />
  < /div>
  < /div>
  ...
  className = "row" >
    < div
  className = {cn('col-md-8', styles.draggedDescription, styles.edit_settings
)
}>
<
  FormTitle
...
<
  CustomDragLayer / >
  < div
  className = {cn('row', styles.noPadding
)
}>
  {
...
<
  ...
  toggle = {this.toggleDropDownFields} >
    < DropdownToggle >
    < FormattedMessage
  id = "content-manager.containers.SettingPage.addField" >
  ...
  }
  {
    this.hasRelations() && (
    < div
    className = {cn('col-md-4', styles.draggedDescription, styles.edit_settings
  )
  }>
  <
    FormTitle
  ...
  <
    ...
    toggle = {this.toggleDropdownRelations}
      ...
      < DropdownToggle >
      < FormattedMessage
    id = "content-manager.containers.SettingPage.addRelationalField" >
      {this.renderDropDownP}
      < /FormattedMessage>
      < /DropdownToggle>
      < DropdownMenu >
...
<
  ...
  className = "col-md-12" >
    < div
  className = "row" > {forms.inputs.map(this.renderInputMainSettings)} < /div>
    < /div>
  ...
  className = "row" >
    < div
  className = {cn('col-md-12', styles.draggedDescription
)
}>
<
  FormTitle
...
<
  ...
  className = {styles.editWrapper} >
    < div
  className = "row" > {forms.editList.map(this.renderFormListAttrSettings)} < /div>
    < /div>
    < /div>
  {/* LIST ATTR FORM */
  }
...
=>
  ...
  < HeaderNav
  links = {this.generateHeaderNavLinks()}
  />
  < div
