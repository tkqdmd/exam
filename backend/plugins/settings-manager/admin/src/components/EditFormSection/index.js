...
class EditFormSection extends React.Component { // eslint-disable-line react/prefer-stateless-function
  ...
  <
    div
    className = {this.props.styles.spacer}
    /> : '';
  ...
  <
    div
    className = {this.props.styles.sectionDescription} > {this.props.section.description} < /div> : '';
    return (
      < div
    className = {this.props.styles.editFormSection} >
      < div
    ...
    className = "col-md-12" >
      < span
    className = {this.props.styles.sectionHeader} >
      {sectionName}
      < /span>
    {
      sectionDescription
