...
class RowLanguage extends React.Component { // eslint-disable-line react/prefer-stateless-function
  ...
  =>
    ...
    < div
    className = {this.props.liStyles.italicText} >
      {message}
      < /div>
  )
  }
  ...
  :
    ...
    < FormattedMessage
    id = "settings-manager.list.languages.set.languages" >
      {(message)
  =>
    (
    < button
  ...
  <
    div
    className = {this.props.liStyles.hoveredLanguage}
    />
    < div
    className = {this.props.liStyles.language}
    />
    < div
    className = {`${this.props.liStyles.borderBottom} ${this.props.liStyles.flexLiLanguage}`
  }>
  <
    div
    className = {`${this.props.liStyles.flexed} ${this.props.liStyles.flagContainer}`
  }>
  <
    div > < span
    className = {`${this.props.liStyles.flag} flag-icon flag-icon-${flag}`
  }
    /></
    div >
    < div
    className = {`${this.props.liStyles.label} ${this.props.liStyles.capitalized}`
  }>
    {
      languageDisplay
    }
  ...
  <
    div
    className = {this.props.liStyles.centered} > {languageLabel} < /div>
      < div
    className = {this.props.liStyles.trashContainer} > {deleteIcon} < /div>
      < /div>
      < /div>
      < div >
      < PopUpWarning
