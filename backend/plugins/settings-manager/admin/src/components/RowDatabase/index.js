...
class RowDatabase extends React.Component { // eslint-disable-line react/prefer-stateless-function
  ...
  <
    ...
    disabled = {this.state.loader} > < p
    className = {styles.saving} > < span >
  .<
    /span><span>.</s
    pan > < span >
  .<
  ...
  :
    (
    < FormattedMessage
    id = "settings-manager.form.button.save" >
      {(message)
  =>
    (
    < Button
    onClick = {this.handleSubmit}
    className = {styles.primary} > {message} < /Button>
  )
  }
  <
    /FormattedMessage>
  ...
  <
    div
    className = {styles.ico} > < i
    className = "fa fa-pencil"
    id = {this.props.data.name}
    /></
    div >
    < div
    className = {`${styles.leftSpaced} ${styles.ico}`
  }><
    i
    id = "trash"
    ...
    className = {styles.modalPosition} >
      < ModalHeader
    toggle = {this.toggle}
    className = {`${styles.noBorder} ${styles.padded} ${styles.mHeader}`
  }>
    Databases
    < /ModalHeader>
    < div
  ...
  <
    FormattedMessage
    id = "settings-manager.form.button.cancel" >
      {(message)
  =>
    (
    < Button
    onClick = {this.handleToggle}
    className = {styles.secondary} > {message} < /Button>
  )
  }
  <
    /FormattedMessage>
